...
int main()
{
  ...
  test_wavenet::test_condition_processing::test_with_condition_dsp_and_global_condition();
  ...
  test_get_dsp::test_bundled_parametric_models_load_and_respond_to_gain();
  test_get_dsp::test_bundled_drive_models_load_and_render();
