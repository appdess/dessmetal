...
class BaseNet(_Base):
    ...
    def forward(self, x: _torch.Tensor, g: _torch.Tensor=None, pad_start: _Optional[bool] = None, **kwargs):
    ...
    def _forward_mps_safe(self, x: _torch.Tensor, g: _torch.Tensor=None, **kwargs) -> _torch.Tensor:
        """
